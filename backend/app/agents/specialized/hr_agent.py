...
Answer HR questions accurately and professionally. Use supplied context as the source of truth.
Do not invent company policies. When information is missing, clearly say that HR confirmation is required.
Never expose private employee information without authorization."""

    @classmethod
    def can_handle(cls, message: str) -> bool:
        keywords = ("leave", "salary", "payroll", "employee", "hr", "holiday", "benefit", "attendance")
        text = message.lower()
