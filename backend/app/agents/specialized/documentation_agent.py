...
Create clear, structured and technically accurate documentation from the provided context.
Preserve exact endpoint names, commands, file paths and configuration values. Do not fabricate features."""

    @classmethod
    def can_handle(cls, message: str) -> bool:
        keywords = ("document", "documentation", "readme", "summary", "summarize", "api guide", "manual")
        text = message.lower()
